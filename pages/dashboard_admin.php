                                ...
                                <div class="row">
                                    <div class="col-xs-8">
                                        <h5 class="list-group-item-heading">
                                            ...
                                            <span class="label label-<?= $ipsActive ? 'success' : 'danger' ?>">
                                                <?= $ipsActive ? 'Aktiv' : 'Inaktiv' ?>
                                            </span>
                                        </h5>
                                        <p class="list-group-item-text text-muted">
                                            <?= $stats['blocked_ips'] ?> gesperrte IPs, <?= $stats['threats_today'] ?> Bedrohungen heute
                                        </p>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-8">
                                        <h5 class="list-group-item-heading">
                                            ...
                                            <span class="label label-<?= $frontendMaintenanceActive ? 'warning' : 'success' ?>">
                                                <?= $frontendMaintenanceActive ? 'Wartung' : 'Online' ?>
                                            </span>
                                        </h5>
                                        <p class="list-group-item-text text-muted">
                                            <?= $allowedIpCount ?> erlaubte IPs für Wartung
                                        </p>
                                    </div>
                                    <div class="col-xs-4 text-right">
                                ...
                                <div class="row">
                                    <div class="col-xs-8">
                                        <h5 class="list-group-item-heading">
                                            ...
                                            Mail Security
                                            <span class="label label-<?= ($mailStats['active'] ?? false) ? 'success' : 'default' ?>">
                                                <?= ($mailStats['active'] ?? false) ? 'Aktiv' : 'Inaktiv' ?>
                                            </span>
                                        </h5>
                                        <p class="list-group-item-text text-muted">
                                            <?= $mailStats['threats_24h'] ?? 0 ?> blockierte E-Mails heute
                                        </p>
                                    </div>
                                    <div class="col-xs-4 text-right">
                                        <a href="<?= rex_url::backendPage('upkeep/mail_security') ?>" class="btn btn-sm btn-primary">
                                            <i class="rex-icon fa-cog"></i> Verwalten
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-8">
                                        <h5 class="list-group-item-heading">
                                            ...
                                            <span class="label label-<?= $backendMaintenanceActive ? 'warning' : 'success' ?>">
                                                <?= $backendMaintenanceActive ? 'Wartung' : 'Online' ?>
                                            </span>
                                        </h5>
                                        <p class="list-group-item-text text-muted">
                                            Backend nur für Administratoren
                                        </p>
                                    </div>
                                    <div class="col-xs-4 text-right">
                                        <?php if ($user->isAdmin()): ?>
                                ...
                                <div class="row">
                                    <div class="col-xs-8">
                                        <h5 class="list-group-item-heading">
                                            ...
                                            Domain Redirects
                                            <span class="label label-<?= $domainMappingSystemActive ? 'success' : 'default' ?>">
                                                <?= $domainMappingSystemActive ? 'Aktiv' : 'Inaktiv' ?>
                                            </span>
                                        </h5>
                                        <p class="list-group-item-text text-muted">
                                            <?= $activeRedirects ?> von <?= $totalRedirects ?> Redirects aktiv
                                        </p>
                                    </div>
                                    <div class="col-xs-4 text-right">
                                        ...
                                        <form method="post" style="display: inline; margin-right: 5px;">
                                            ...
                                            <button type="submit" class="btn btn-sm <?= $domainMappingSystemActive ? 'btn-warning' : 'btn-success' ?>">
                                                <i class="rex-icon fa-<?= $domainMappingSystemActive ? 'pause' : 'play' ?>"></i>
                                            </button>
                                        </form>
                                        <?php endif; ?>
                                        <a href="<?= rex_url::backendPage('upkeep/domains') ?>" class="btn btn-sm btn-primary">
                                            <i class="rex-icon fa-cog"></i> Verwalten
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="list-group-item" style="margin-bottom: 10px; border-radius: 4px;">
                                <div class="row">
                                    <div class="col-xs-8">
                                        ...
                                        <p class="list-group-item-text text-muted">
                                            REDAXO <?= $rexVersion ?>, PHP <?= $phpVersion ?>
                                        </p>
                                    </div>
                                    <div class="col-xs-4 text-right">
